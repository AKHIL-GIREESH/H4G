...
function Sidebar({ onSelectChannel, onSelectGroup }) {
  ...
  const handleCreateGroup = (channelId) => {
  ...
  const handleSelectGroup = (channelId, groupId) => {
    setSelectedChannelId(channelId);
            ...
            <div className="ml-4 mt-2">
              ...
              <Dialog>
                ...
                <DialogContent>
                  ...
                  />
                  <Button onClick={() => handleCreateGroup(channel.id)}>
                    Create
                  </Button>
                </DialogContent>
              </Dialog>
